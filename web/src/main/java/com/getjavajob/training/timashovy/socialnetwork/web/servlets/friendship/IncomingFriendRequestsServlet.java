...
public class IncomingFriendRequestsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("friendRequests", getApplicationContext(req.getServletContext()).getBean(ACCOUNT_SERVICE_BEAN,
                AccountService.class).getIncomingFriendRequests(accountId));
