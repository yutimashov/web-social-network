...
import static com.getjavajob.training.timashovy.socialnetwork.service.serviceimpl.AdminServiceImpl.getAdminServiceImpl;
...
public class MakeAdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        adminService.makeAdmin(valueOf(accountId));
