...
/**
 * Class creates `fake connection`. It overrides only one method {@link ConnectionWrapper#close()}.
 * Rather than just close connection, instance of this class returns this connection to connection pool.
 *
